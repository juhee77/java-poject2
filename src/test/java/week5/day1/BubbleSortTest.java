...
class BubbleSortTest {
    ...
    public void testBubble() {
        int[] name = {2, 5, 2, 57, 34, 12, 65, 226, 47, 34, 6, 5, 342, 123};
        BubbleSort bs = new BubbleSort(Comparator.comparingInt(o -> o));
        int[] ints = bs.sortAround(name);

        assertArrayEquals(ints, new int[]{2, 2, 5, 5, 6, 12, 34, 34, 47, 57, 65, 123, 226, 342});
    }
    ...
    public void testBubble2() {
        ...
        assertArrayEquals(ints, new int[]{342, 226, 123, 65, 57, 47, 34, 34, 12, 6, 5, 5, 2, 2});
    }
