package com.example.javaprojtectest2.week7.day4.view;
import com.example.javaprojtectest2.week7.day4.service.OpGame;
import com.example.javaprojtectest2.week7.day4.service.PlusOperatorLevelOne;
...
public class MainGUI extends JFrame {
    ...
    private void loadCharImages() {
        String[][] imgResources = {
                {"normal", "/character_men.gif"},
                {"success", "/character_men_a.gif"},
                {"fail", "/character_men_b.gif"}
        };

        for (int i = 0; i < imgResources.length; i++) {
            //ImageIcon객체를 생성
            String name = imgResources[i][1];
            URL resource = MainGUI.class.getResource(name);
            ImageIcon originIcon = new ImageIcon(name);
